                ...
                <div className="form">
                    ...
                    <select name="grado" id="degree">
                        ...
                        <optgroup label="Administración y Comercio">
                            <option value="ad-finanzas">
                                Administración y Finanzas
                            </option>
                            <option value="asistencia-dir">
                                Asistencia a la Dirección
                            </option>
                            <option value="comercio-int">
                        ...
                        <optgroup label="Servicios a la Comunidad">
                            ...
                            <option value="igualdad">
                                Promoción de Igualdad de Género
                            </option>
                            <option value="mediacion">
                        ...
                        <optgroup label="Industria y Edificación">
                            ...
                            <option value="mantenimiento-elec">
                                Sistemas Electrotécnicos y Automatizados
                            </option>
                            <option value="proyectos-ed">
                        ...
                        <optgroup label="Imagen, Sonido y Hostelería">
                            <option value="3d-juegos">
                                Animaciones 3D, Juegos y Entornos Interactivos
                            </option>
                            <option value="realizacion">
                                Realización de Proyectos de Audiovisuales y
                                Espectáculos
                            </option>
                        ...
                        <optgroup label="Imagen Personal">
                            ...
                            <option value="estilismo">
                                Estilismo y Dirección de Peluquería
                            </option>
                            <option value="caracterizacion">
